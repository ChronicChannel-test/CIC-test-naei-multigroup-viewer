...
function showShareDialog() {
  ...
  // Build shareable URL with parameters
  const params = new URLSearchParams();
  params.set('year', chartData.year);
  params.set('pollutant_id', chartData.pollutantId);
  params.set('group_ids', chartData.groupIds.join(','));
